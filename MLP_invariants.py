...
while _loss > 0.1:
    ...
    if t % 1000 == 0:
        ...
        with open('/media/qujiagang/LocalDiskB/Invariance/JCP-LING/relative_loss/relative_loss', 'a') as file:
            file.write(str(float(loss_))+'  '+str(float(loss__))+'\n')
        torch.save(net, '/media/qujiagang/LocalDiskB/Invariance/JCP-LING/relative_loss/relative_loss-%d.net' % t)


torch.save(net, 'relative_loss.net')
